...
func NewCmdInstall() *cobra.Command {
  ...
  # please follow these steps to install dory-core with kubernetes (for production recommended):
  ...
  ##############################
  please follow these steps to install dory-core with docker (for test only):
